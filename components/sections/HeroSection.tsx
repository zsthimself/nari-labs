      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col items-center lg:flex-row lg:gap-8 lg:justify-center">
          ...
          <div className="lg:w-3/5 flex justify-center items-center">
            <div className="bg-black rounded-2xl overflow-hidden shadow-2xl p-8 w-full max-w-xl">
              ...
              <div className="text-amber-500 text-base mb-2">[S1] Dia is a text to dialogue model.</div>
              <div className="text-white text-base mb-2">[S2] You get full control over scripts and voices.</div>
              <div className="text-amber-500 text-base mb-5">[S1] Wow. Amazing. (laughs)</div>
