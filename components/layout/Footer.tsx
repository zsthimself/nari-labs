      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          <div className="flex flex-col">
            <div className="flex items-center gap-2">
              ...
              />
              <span className="text-lg font-semibold text-gray-900">Nari Labs</span>
            </div>
            <p className="mt-4 text-sm text-gray-600">
              Pioneers in open-source text-to-speech AI technology, providing developers with powerful and flexible voice synthesis solutions.
            </p>
            <div className="mt-4 flex space-x-4">
              <a href="#" aria-label="Twitter" className="text-gray-500 hover:text-gray-900">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743A11.65 11.65 0 013.36 4.111a4.106 4.106 0 001.27 5.477A4.072 4.072 0
                  2.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84"></path>
                </svg>
              </a>
          ...
          <div>
            <h3 className="text-sm font-semibold uppercase tracking-wider text-gray-900">Products</h3>
        ...
        <div className="mt-12 border-t border-gray-200 pt-8">
          <p className="text-center text-xs text-gray-500">
            &copy; {new Date().getFullYear()} Nari Labs. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
